  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <Box
        ...
        sx={{ 
          flexGrow: 1, 
          mt: 8, // Adjusted mt slightly (from 10 to 8) for standard AppBar height spacing
          // 👈 FIX: Added padding and minHeight
          px: 3, // Padding Left and Right (e.g., 24px)
          py: 2, // Padding Top and Bottom
          minHeight: '100vh', // Ensures the background stretches full height
          bgcolor: '#f9f9f9' // Optional: set a light background for the content area
        }}
      >
        <AppRoutes />
      </Box>
