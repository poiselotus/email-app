        ...
        {companies.map((company) => (
          <Box
            ...
            sx={{
              ...
              bgcolor: "white", 
              // IMPORTANT FIX: Ensures the row doesn't force its way out of the parent
              minWidth: 0, 
              '&:hover': { bgcolor: '#f5f5f5' }
            }}
          >
            {/* The company name typography is set to prevent wrapping or overflowing its line */}
            <Typography 
                variant="body1" 
